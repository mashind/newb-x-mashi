...
#define NL_MORNING_SUN_COL vec3(1.0,0.35,0.0)
#define NL_NOON_SUN_COL    vec3(1.0,0.875,0.875)
#define NL_NIGHT_SUN_COL   vec3(0.025,0.05,0.05)
...
#define NL_UNDERWATER_TORCH_COL vec3(0.85,0.55,0.555)
#define NL_NETHER_TORCH_COL     vec3(1.05,0.65,0.655)
#define NL_END_TORCH_COL        vec3(0.85,0.5,0.35)
...
#define NL_DAY_ZENITH_COL    vec3(0.015,0.15,1.0)
#define NL_DAY_HORIZON_COL   vec3(0.45,0.8,1.05)
#define NL_NIGHT_ZENITH_COL  vec3(0.0,0.015,0.055)
#define NL_NIGHT_HORIZON_COL vec3(0.0,0.025,0.15)
#define NL_RAIN_ZENITH_COL   vec3(0.6,0.6,0.6)
#define NL_RAIN_HORIZON_COL  vec3(0.85,0.85,0.85)
...
#define NL_WATER_TINT vec3(0.0,1.0,0.7)
...
#define NL_UNDERWATER_TINT vec3(0.0,0.65,0.4) // fog tint color when underwater
...
#define NL_LAVA_NOISE_BUMP 0.05 // [toggle] 0.1 subtle ~ 0.8 massive waves
#define NL_LAVA_NOISE_SPEED 0.01 // 0.0 still ~ 0.1 fast
